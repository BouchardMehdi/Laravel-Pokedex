...
@php
  ...
  $backUrl = route('pokemons.index') . ($isPickMode ? ('?pick_team=' . $pickTeamId . '&slot=' . $pickSlot) : '');
  $prevUrl = !empty($prevPokemon)
      ? route('pokemons.show', $prevPokemon) . ($isPickMode ? ('?pick_team=' . $pickTeamId . '&slot=' . $pickSlot) : '')
      : null;
  $nextUrl = !empty($nextPokemon)
      ? route('pokemons.show', $nextPokemon) . ($isPickMode ? ('?pick_team=' . $pickTeamId . '&slot=' . $pickSlot) : '')
      : null;
@endphp

<div class="pokemon-show-page">
        ...
        @if($isPickMode)
          <div class="pick-actions">
            <form method="POST"
              ...
              <button class="variant-btn pick-btn" type="submit">
                ➕ Add to team (slot {{ (int) $pickSlot }})
              </button>
            </form>

            <a class="variant-btn pick-btn"
